...
namespace StudentQueries
{
	class Program
	{
		static void CopyToDatabase(MOContext context)
		{
		...
		static void FilterAndOrder(MOContext context)
		{
		...
		static void Join(MOContext context)
		{
			var result = from s in context.Students
		...
		static void GroupByFirstLetter(MOContext context)
		{
			var result = from s in context.Students
		...
		{
			using (MOContext c = new MOContext())
			{
